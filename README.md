...
|---|---|---|
| Model | Llama 3.3 70B (via Groq API) | Llama 3.3 70B is chosen as the default model. It provides state-of-the-art open-source reasoning capabilities, highly accurate instruction following for JSON mode, and ultra-fast inference speed via Groq. |
